...
public class LoadDBtrain4fair_deCloudTest {
	...
	public EnvironmentProperties getEnvMockProperties() {
		...
		microservicesPropertiesTESTModel.setHost("train4fair.de");
		...
		mongoMicroservicesPropertiesTESTModel.setHost("train4fair.de");
		...
		trainModellingToolPropertiesTESTModel.setHost("train4fair.de");
		...
		trainNodesPropertiesTESTModel.setHost("train4fair.de");
		...
		webdavMicroServicesPropertiesTESTModel.setHost("train4fair.de");
		...
		webdavMetadataPropertiesTESTModel.setHost("train4fair.de");
		...
		webdavDocumentationPropertiesTESTModel.setHost("train4fair.de");
		...
		webdavPagePropertiesTESTModel.setHost("train4fair.de");
