...
public class LoadDBCloudMenzelTest {
	...
	public EnvironmentProperties getEnvMockProperties() {
		...
		microservicesPropertiesTESTModel.setHost("menzel.informatik.rwth-aachen.de");
		...
		mongoMicroservicesPropertiesTESTModel.setHost("menzel.informatik.rwth-aachen.de");
