...
public class LoadDBtrain4fair_srv03Test {
	...
	public EnvironmentProperties getEnvMockProperties() {
		...
		microservicesPropertiesTESTModel.setHost("167.172.171.239");
		...
		mongoMicroservicesPropertiesTESTModel.setHost("167.172.171.239");
		...
		trainModellingToolPropertiesTESTModel.setHost("167.172.171.239");
		...
		trainNodesPropertiesTESTModel.setHost("167.172.171.239");
		...
		webdavMicroServicesPropertiesTESTModel.setHost("167.172.171.239");
		...
		webdavMetadataPropertiesTESTModel.setHost("167.172.171.239");
		...
		webdavDocumentationPropertiesTESTModel.setHost("167.172.171.239");
		...
		webdavPagePropertiesTESTModel.setHost("167.172.171.239");
