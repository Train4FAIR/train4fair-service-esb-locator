...
if ([ $1 = "--init" ] && [ $2 = true ]); then
	...
	echo "Copying files to cloud "$DIG_OCEAN_DAV_HOST:/webdav/documentation/data/installation/development
	echo "Please wait..."
	...
	sudo sshpass -p $DIG_OCEAN_DAV_PASS scp setup.tar.gz installation.tar.gz $DIG_OCEAN_DAV_USER@$DIG_OCEAN_DAV_HOST:/webdav/documentation/data/installation/development
	...
	#scp ~/workspaces/inbraMarketingCode/venv/pub/train4fairdeployicon.png root@167.172.175.112:/webdav/documentation/data/media/static/files/img/
	#scp /Users/jbjares/workspaces/PHTWorkspace/central_workspace/node-red-contrib-train-nodeset/nodes/core/train/icons/train.png root@167.172.175.112:/webdav/documentation/data/media/static/files/img/
